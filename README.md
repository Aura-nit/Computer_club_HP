...
米子高専コンピュータ同好会の公式ホームページプロジェクトである.
Vite + Vanilla JavaScript + CSS で構築されており, シンプルかつ高速に動作する.
...
npm run deploy
```
※事前にGitHubリポジトリの設定が必要である (詳細は `deployment_guide.md` を参照).
